...
var Juego = {
  ...
  obstaculosCarretera: [
    ...
    new Obstaculo('imagenes/valla_horizontal.png', 480, 410, 30, 30, 1),
    ...
    new Obstaculo('imagenes/auto_verde_abajo.png', 850, 360, 15, 30, 3),
  ...
  enemigos: [
    new ZombieCaminante('imagenes/zombie1.png', 850, 100, 10, 10, 1, rangoMov),
    new ZombieCaminante('imagenes/zombie2.png', 850, 150, 10, 10, 2, rangoMov),
    new ZombieCaminante('imagenes/zombie3.png', 850, 220, 10, 10, 3, rangoMov),
    new ZombieCaminante('imagenes/zombie4.png', 850, 300, 10, 10, 1, rangoMov),
    new ZombieCaminante('imagenes/zombie1.png', 850, 400, 10, 10, 1, rangoMov),
    new ZombieCaminante('imagenes/zombie2.png', 850, 450, 10, 10, 2, rangoMov),

    new ZombieConductor('imagenes/tren_vertical.png', 644, 577, 30, 90, 3, rangoMov, 'v'),
    new ZombieConductor('imagenes/tren_vertical.png', 674, 577, 30, 90, 2, rangoMov, 'v'),
    new ZombieConductor('imagenes/tren_horizontal.png', 400, 325, 90, 30, 4, rangoMov, 'h')
...
Juego.dibujar = function() {
  ...
  Dibujante.dibujarRectangulo("#FF0000", 760, 530, 127, 15);
